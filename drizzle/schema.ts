...
export const clientInquiries = mysqlTable("client_inquiries", {
  ...
  eventType: varchar("eventType", { length: 100 }).notNull(), // e.g., Wedding, Corporate, Celebration.
  eventDate: timestamp("eventDate"),
  location: varchar("location", { length: 300 }),
  budget: varchar("budget", { length: 100 }),
  guestCount: int("guestCount"),
  serviceInterest: varchar("serviceInterest", { length: 200 }), // e.g., Photography, Video, Both.
