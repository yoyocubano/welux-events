...
export default function Portfolio() {
  ...
  const allProjects = [
    ...
    },
    {
      ...
      coverImageUrl: "/private-dinner.png",
      media: [
    ...
    },
    {
      ...
      coverImageUrl: "/sbk-bachata-sensual.png",
      media: [
        { type: "image", url: "/sbk-dance-cover.png" },
  ...
  const portfolioSchema = {
    ...
    "mainEntity": allProjects.map(project => ({
      "@type": "CreativeWork",
      "name": project.title,
      "description": project.description,
      "image": `https://weluxevents.com${project.coverImageUrl}`,
                ...
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-2 text-sm text-primary mt-3 font-medium">
                      ...
                      {videoCount > 0 && <span>• {videoCount} {t("portfolio.video_label", { defaultValue: "Videos" })}</span>}
                      <span>→</span>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="relative w-full h-full flex flex-col">
              ...
              <div className="p-6 text-white bg-gradient-to-t from-black/80 to-transparent absolute bottom-0 w-full">
                ...
                <div className="flex items-center gap-4 text-sm text-white/70">
                  ...
                  <p>
                    {t("portfolio.gallery_counter", { current: currentMediaIndex + 1, total: selectedProject.media?.length || 0 })}
                  </p>
                </div>
              </div>
            </div>
